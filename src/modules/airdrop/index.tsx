      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-4 items-center">
        <div>
          ...
          <div className="mt-4 font-medium text-white">
            {`Join BaseVe's beta testing program to provide valuable feedback and be rewarded for your active participation in our community-driven initiative. BaseVe is dedicated to continuously improving and optimizing our platform to cater to the evolving needs of our users, and we value the collaborative efforts of our community in achieving this goal.`}
          </div>
          <div className="mt-6 font-sans">
            <div
              onClick={() =>
                window.open(
                  'https://docs.BaseVe.finance/tokenomics/BaseVe-airdrop',
                  '_blank'
                )
              }
