  ...
  <div className="bg-slate-950">
    <Section>
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-4 mt-12">
        <FeatureCard
          image={
            <Image src={ExchangeGif} alt="my gif" height={400} width={400} />
          }
          title="EXCHANGE"
        ...
        <FeatureCard
          image={
            <Image src={LiquidityGif} alt="my gif" height={400} width={400} />
          }
          title="LIQUIDITY"
        ...
        <FeatureCard
          image={<Image src={StakeGif} alt="my gif" height={400} width={400} />}
          title="STAKE"
        ...
        />
        <FeatureCard
          image={<Image src={FarmGif} alt="my gif" height={400} width={400} />}
          title="FARM"
        ...
        <FeatureCard
          image={
            <Image src={LaunchpadGif} alt="my gif" height={400} width={400} />
          }
          title="launchpad"
        ...
        <FeatureCard
          image={<Image src={VeGif} alt="my gif" height={400} width={400} />}
          title="Ve(3,3)"
